...
class ModuladorPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._Off_range = Range(-1, 1, 0.1, 0, 200)
        self._Off_win = RangeWidget(self._Off_range, self.set_Off, "Offset", "counter_slider", float, QtCore.Qt.Horizontal)
