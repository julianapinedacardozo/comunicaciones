...
class ModulacionPM65(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionPM65")
        ...
        self._Ac_range = Range(0, 2, 0.01, 0.2, 200)
...
def main(top_block_cls=ModulacionPM65, options=None):
